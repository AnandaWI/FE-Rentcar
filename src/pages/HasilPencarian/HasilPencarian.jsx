                            ...
                            <Row>
                                ...
                                <Col md={2}>
                                    <div className="search-item">
                                        ...
                                        <p className="mb-0">
                                            <Badge bg={searchParams.kategori === 'VIP' ? 'warning' : 'secondary'}>
                            ...
                            <Card className="car-card h-100 shadow-sm">
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text className="price mb-0">
                                        ...
                                        <div className="fw-bold fs-5">Rp {car.price.toLocaleString('id-ID')}/hari</div>
                                    </Card.Text>
                                </Card.Body>
                                <Card.Footer className="bg-white border-top-0">
                                    <button 
    className="btn btn-primary w-100" 
    onClick={() => navigate('/driver', { state: { car, searchParams } })}
>
    Pilih Mobil
</button>
                                </Card.Footer>
